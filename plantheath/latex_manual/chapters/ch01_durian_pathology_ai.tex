...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{figures/diseases/phytophthora_dual.jpg}
\caption{การเปรียบเทียบรอยโรคใบไหม้ไฟทอปธอร่าระหว่างภาพถ่ายมาโครสมจริงกับภาพลายเส้นวิเคราะห์ขอบเขตแผลปัญญาประดิษฐ์}
\label{fig:phytophthora_dual}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{figures/diseases/rhizoctonia_dual.jpg}
\caption{การเปรียบเทียบรอยโรคราใบติดระหว่างภาพถ่ายมาโครสมจริงกับภาพลายเส้นวิเคราะห์การแผ่กระจายเส้นใยราปัญญาประดิษฐ์}
\label{fig:rhizoctonia_dual}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{figures/diseases/anthracnose_dual.jpg}
\caption{การเปรียบเทียบรอยโรคแอนแทรคโนสระหว่างภาพถ่ายมาโครสมจริงกับภาพลายเส้นวิเคราะห์วงแหวนศูนย์กลางปัญญาประดิษฐ์}
\label{fig:anthracnose_dual}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{figures/diseases/algalspot_dual.jpg}
\caption{การเปรียบเทียบจุดสนิมสาหร่ายระหว่างภาพถ่ายมาโครสมจริงกับภาพลายเส้นระบุพิกัดศูนย์กลางกลุ่มจุดปัญญาประดิษฐ์}
\label{fig:algalspot_dual}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{figures/diseases/pestdamage_dual.jpg}
\caption{การเปรียบเทียบความเสียหายจากไรแดงและเพลี้ยไก่แจ้ระหว่างภาพถ่ายมาโครสมจริงกับภาพลายเส้นวิเคราะห์แผนที่ความหนาแน่นจุดประปัญญาประดิษฐ์}
\label{fig:pestdamage_dual}
\end{figure}

\subsection{การวิเคราะห์เปรียบเทียบพยาธิสภาพรอยโรคแบบพหุรูปแบบ (Multi-Modal Pathology Synthesis)}
ระบบ DurianLeaf AI ผสานโครงสร้างภาพถ่ายความละเอียดสูงเข้ากับอัลกอริทึมการแปลงเป็นภาพโครงร่างลายเส้นดิจิทัล (Digital Line-Art Wireframe) เพื่อช่วยให้เกษตรกรและผู้เชี่ยวชาญสามารถเปรียบเทียบรอยโรคจริงกับขอบเขตการคำนวณของโครงข่ายประสาทเทียมได้อย่างชัดเจน ดังแสดงในรูปที่ \ref{fig:durian_pathology_dual}

\begin{figure}[H]
\centering
\includegraphics[width=0.96\textwidth]{figures/durian_pathology_dual_art.jpg}
\caption{การเปรียบเทียบภาพรวมพยาธิสภาพรอยโรคใบพืชทุเรียนระหว่างภาพถ่ายสมจริงกับภาพโครงร่างเชิงลายเส้นวิเคราะห์โดยปัญญาประดิษฐ์}
\label{fig:durian_pathology_dual}
\end{figure}

รูปที่ \ref{fig:durian_pathology_dual} แสดงการวิเคราะห์เปรียบเทียบแบบคู่ขนาน (Dual-Modality Representation) โดยฝั่งซ้ายเป็นภาพถ่ายมาโครสมจริงความละเอียดสูง แสดงสัณฐานวิทยาของรอยโรคแท้จริงในแปลงเกษตร ได้แก่ แผลฉ่ำน้ำเน่าดำของโรคใบไหม้ไฟทอปธอร่า รอยแผลน้ำร้อนลวกพร้อมเส้นใยราของโรคราใบติด และวงแหวนซ้อน concentric rings ของโรคแอนแทรคโนส ในขณะที่ฝั่งขวาคือภาพเชิงลายเส้นเรืองแสง (Futuristic Vector Wireframe) บนพื้นหลัง Dark Slate ซึ่งจำลองผลการประมวลผลของโมเดลปัญญาประดิษฐ์ ที่สามารถตีกรอบตรวจจับ (Bounding Box), ล้อมเส้นขอบเขตรอยโรค (Lesion Contour Mask) และแสดงค่าคะแนนความเชื่อมั่น (Confidence Score) ได้อย่างแม่นยำ
